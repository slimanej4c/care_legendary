            ...
            <div className='aprops-part2'>
                ...
                Parfois, quand une offre est simplement trop belle,
                 la première question à poser à cet interlocuteur trop
                  ...
                  au juste, chez Car Legendary Monaco, pour mettre à votre disposition
                   des prestations aussi reluisantes que les voitures que nous avons 
                   à vous faire parvenir ? Peut-être sommes-nous – et même sans aucun
                    doute – ceux à qui vous ferez appel très prochainement pour acquérir
                     votre voiture de luxe premier choix.
                    ...
                    <div  className='aprops-part3-image'>
                        ...
                        En tant que prestataire en achat / vente de véhicules sur Monaco,
                         nous agissons pour votre compte afin de satisfaire vos besoins.
                          ...
                          aussi exigeant puisse être ce dernier, nous l’accomplirons sans 
                          que vous n’ayez à donner de votre temps.

                            Du temps, vous en gagnerez à foison à faire appel à nous.
                             D’abord car nous nous occupons de toutes les démarches pour votre compte.
                              Cela part de la recherche du modèle de votre choix, 
                              aux négociations afin d’obtenir toutes les caractéristiques sur-mesure
                               que vous désirez pour enfin aboutir à la transaction dont nous nous 
                               chargerons. Faire appel à nos services suffit à ce que vos affaires
                                soient parfaitement prises en main, et avec brio qui plus est.
                                Mais du temps, nous vous en ferons aussi gagner par l’efficacité 
                                de nos prestations. Les témoignages de nos clients sont là pour
                                 en témoigner ; même les commandes les plus difficiles à 
                                 fournir vous seront livrées en des délais record. Vite fait 
                                 et bien fait, c’est ainsi que doivent se dérouler des affaires rondement menées.
                        ...
                        <p >Si vous imaginez qu’un intermédiaire n’est qu’une somme supplémentaire 
                            ...
                            Car, non-content de rechercher et même vous livrer la voiture de vos rêves,
                             Car Legendary Monaco se fait fort de négocier pour vous les meilleurs prix au
                              regard de ce que vous recherchez.

                            Un partenaire de confiance, c’est d’abord un expert, puis, un homme de réseaux.
                             Un homme qui sait à qui s’adresser quand une requête spécifique lui est confiée.
                              Car Legendary Monaco, du fait de ses connaissances du milieu des voitures de luxe,
                               connaît le chemin jusqu’au Graal. S’en remettre à ses bons soins,
                                c’est se faire guider jusqu’à la réussite dans vos projets automobiles.

                            Qui plus est, une voiture de luxe, quand celle-ci doit être sur-mesure, 
                            ne s’obtient pas si facilement à moins de bénéficier du soutien d’un expert
                             en la matière. Nous parlons là d’une expertise dont vous ne sauriez 
                             raisonnablement vous priver. Car alors, vous passeriez à côté de l’opportunité 
                             d’acquérir la voiture de vos rêves. Or, on ne badine pas avec ses rêves,
                              ...
                              Les services d’un prestaire automobile, d’autant plus quand il est question
                               de voiture de luxe, est un avantage dont il ne faut en aucun cas se priver.
                                Ceux-ci constituent l’assurance d’un travail bien fait et vous garantissent
                                 que jamais la déception ne sera à la clé car la réussite lui aura toujours
                                  emboîté le pas. Pour une affaire aussi importante que l’acquisition d’une
                                   voiture de luxe sur-mesure, il ne serait pas sérieux de faire l’impasse sur 
                                   les conseils et les prestations d’un expert
                              </p>
                    </div>
